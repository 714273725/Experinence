 ...
 */
public class CityListAdapter extends BaseRecyclerViewAdapter<CityBean.Province.City,CityListAdapter.CityViewHolder> {
    @Override
    ...
    public void onBindViewHolder(CityViewHolder holder, int position) {
        holder.mCityName.setText(getTargetPositionData(position).getCityname());
    }
