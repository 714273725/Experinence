...
public class ViewPagerIndicator extends LinearLayout {
    ...
    private static final float RADIO_TRIANGLE_WIDTH = 1 / 4F;// 用于设置三角形的宽和tab底边的比例，用于屏幕适配
    /**
     * 三角形底边的最大宽度
     */
    ...
    private static final int COLOR_TEXT_NORMAL = Color.parseColor("#888888");
    private static final int COLOR_TEXT_HIGHLIGHT = Color.parseColor("#FF8D12");
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        mPaint.setColor(Color.parseColor("#FF8D12"));
